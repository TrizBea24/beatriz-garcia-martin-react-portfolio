...
export default class App extends Component {
  ...
  checkLoginStatus() { //todo esto es para que deje la sesión inciada aunque se cierre la pestaña
    return axios
      ...
      .then(response => {
        ...
        if (loggedIn && loggedInStatus === "LOGGED_IN") { // If loggedIn and status LOGGED_IN => return data
          return loggedIn;
